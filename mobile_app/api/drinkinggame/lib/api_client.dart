  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'CardDto':
          return CardDto.fromJson(value);
        case 'CardSetBasicDto':
          return CardSetBasicDto.fromJson(value);
        case 'CardSetDto':
          return CardSetDto.fromJson(value);
        case 'CardSetRole':
          return CardSetRoleTypeTransformer().decode(value);
        case 'CardType':
          return CardTypeTypeTransformer().decode(value);
        case 'FeedbackDto':
          return FeedbackDto.fromJson(value);
        case 'UserBasicDto':
          return UserBasicDto.fromJson(value);
        case 'UserDto':
          return UserDto.fromJson(value);
        case 'UserRole':
          return UserRoleTypeTransformer().decode(value);
        case 'UserWithCardSetRole':
          return UserWithCardSetRole.fromJson(value);
        default:
          Match match;
