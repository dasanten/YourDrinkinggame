            ...
            itemBuilder: (context, i) {
              return GestureDetector(
                onTap: () => Navigator.pushNamed(
                    context, WorkshopCardView.routeName,
                    arguments: CardSetCardsArguments(
                        cardSetList[i], cardSetList[i].cardList)),
                child: CustomWorkshopCardSetTile(cardSet: cardSetList[i]),
              );
            },
          ));
